template1 = """
Rewrite the sentence as follows, using as much expression as possible,you must answer in English:
Example 1:
...
Output: Both the hamburgers and perks here are made to be mouthwatering and will be back next time.
Example 3:
Input: Nevertheless the bread itself is pretty bad. rewrite and include the words 'bread'. 
Output: The bread at this store is so uniquely bad, it's hard to believe there's anything in the world that tastes so bad! 
Example 4:
...
Output: It took stretch of time to receive our check, which was entirely acceptable as it gave us time to relax, enjoy our drinks, and engage in conversation!

Input Format:
1. Original sentence 1. rewrite and include the words ...
2. Original sentence 2. rewrite and include the words ...
3. Original sentence 3. rewrite and include the words ...
4. Original sentence 4. rewrite and include the words ...
...
...
3. Rewritten sentence 3.
4. Rewritten sentence 4. 
...
